        ...
        <div className="lower-sections-grid">
          ...
          <div className="saas-card">
            ...
            <div className="quick-actions-list">
              ...
              <button className="action-btn" onClick={() => alert('Compare Properties feature selected.')}>
                <div className="action-left">
              ...
              <button className="action-btn" onClick={() => alert('Exporting Valuation PDF Report...')}>
                <div className="action-left">
              ...
              <button className="action-btn" onClick={() => alert('Valuation link copied to clipboard!')}>
                <div className="action-left">
      ...
      {isModalOpen && (
        <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
          <div className="modal-card" onClick={e => e.stopPropagation()}>
            ...
            <button className="btn-primary-lg" onClick={runValuationInference} disabled={loading} style={{ marginTop: '12px' }}>
              {loading ? 'Evaluating ML Model...' : 'Calculate Property Price'}
            </button>
          </div>
        </div>
      )}
